...
erase_compiled_function('NKa_static');
erase_compiled_function('NKa_dynamic');
M_.orig_eq_nbr = 15;
M_.eq_nbr = 16;
M_.ramsey_eq_nbr = 0;
...
options_.order = 1;
options_.periods = 0;
var_list_ = char('yt','Pi','y','n','wn','P','I','r','m','a');
info = stoch_simul(var_list_);
save('NKa_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('NKa_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('NKa_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('NKa_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('NKa_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('NKa_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('NKa_results.mat', 'oo_recursive_', '-append');
end
