var  yt Pi y yn n  w wn P I r rn m v a z dm;

varexo e_a e_v e_z e_m;

parameters rho alpha beta sigma theta phi e phi_pi phi_y rho_v rho_a rho_z eta k psi_ya  psi_y rho_m;
rho= 1;
alpha = 0.25;
beta = 0.99;
sigma = 1;
...
stoch_simul(order=1, periods=0, irf=16)yt Pi y n wn P I r m dm ;
