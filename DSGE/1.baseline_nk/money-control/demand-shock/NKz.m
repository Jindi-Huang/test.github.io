...
erase_compiled_function('NKz_static');
erase_compiled_function('NKz_dynamic');
M_.orig_eq_nbr = 15;
M_.eq_nbr = 16;
M_.ramsey_eq_nbr = 0;
...
oo_.steady_state(16)=oo_.steady_state(12);
if M_.exo_nbr > 0
...
M_.Sigma_e(1, 1) = (0)^2;
M_.Sigma_e(2, 2) = (0)^2;
M_.Sigma_e(3, 3) = (0.5)^2;
M_.Sigma_e(4, 4) = (0)^2;
options_.irf = 16;
options_.order = 1;
options_.periods = 0;
var_list_ = char('yt','Pi','y','n','wn','P','I','r','m','z');
info = stoch_simul(var_list_);
save('NKz_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('NKz_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('NKz_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('NKz_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('NKz_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('NKz_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('NKz_results.mat', 'oo_recursive_', '-append');
end
