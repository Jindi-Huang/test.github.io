nkv = load("money-shock\NKm_results.mat");
...
subplot(5,2,2)
plot(0:1:15,nkv.oo_.irfs.Pi_e_m*4,'o-','MarkerSize',4)
hold on
...
subplot(5,2,3)
plot(0:1:15,nkv.oo_.irfs.y_e_m,'o-','MarkerSize',4)
hold on
...
subplot(5,2,4)
plot(0:1:15,nkv.oo_.irfs.n_e_m,'o-','MarkerSize',4)
hold on
...
subplot(5,2,5)
plot(0:1:15,nkv.oo_.irfs.wn_e_m,'o-','MarkerSize',4)
hold on
...
subplot(5,2,6)
plot(0:1:15,nkv.oo_.irfs.P_e_m,'o-','MarkerSize',4)
hold on
...
subplot(5,2,7)
plot(0:1:15,nkv.oo_.irfs.I_e_m,'o-','MarkerSize',4)
hold on
...
subplot(5,2,8)
plot(0:1:15,nkv.oo_.irfs.r_e_m,'o-','MarkerSize',4)
hold on
...
subplot(5,2,9)
plot(0:1:15,nkv.oo_.irfs.m_e_m,'o-','MarkerSize',4)
hold on
...
subplot(5,2,10)
plot(0:1:15,4*nkv.oo_.irfs.dm_e_m,'o-','MarkerSize',4)
hold on
