...
residual(1)= lhs-rhs;
lhs =y(11);
rhs =params(17)+y(9)*params(12)+params(13)*y(10)+y(1)*params(14)+params(14)*params(16)*y(8)+y(14);
residual(2)= lhs-rhs;
lhs =y(9);
...
residual(5)= lhs-rhs;
lhs =y(12);
rhs =params(17)-y(8)*params(21)*params(16)*(1-params(19))+(1-params(20))*y(13);
residual(6)= lhs-rhs;
lhs =y(5);
...
if nargout >= 2,
  ...
  g1(5,5)=1;
  g1(5,6)=1;
  g1(6,8)=params(21)*params(16)*(1-params(19));
  g1(6,12)=1;
  g1(6,13)=(-(1-params(20)));
  g1(7,2)=(-(params(21)+params(11)/(1-params(1))));
  g1(7,5)=1;
  g1(7,8)=(-((-params(11))/(1-params(1))));
  g1(8,2)=(-(1-1/(1-params(1))));
  g1(8,5)=1;
  g1(8,8)=(-1)/(1-params(1));
  g1(9,14)=1-params(18);
  g1(10,8)=1-params(19);
