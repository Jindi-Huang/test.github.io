% * Copyright@yoursilver;Time@2019/10/17
% * 在第六章的基础上加上失业
...
//4、NKPC之二：工资的菲利普斯曲线 
Piw = beta*Piw(1)-lambdaw*phi*(u-un);
//5、自然利率
...
//7、由定义得出的工资缺口动态方程
wt = w-wn;
//8、失业率 and labor force
u = 1/phi*(wt-(sigma+phi/(1-alpha))*yt);
w = sigma*y+phi*l;
//9、生产函数
y = a+(1-alpha)*n;
//10、真实工资
...
stoch_simul(order=1, irf=16) u n l w;
